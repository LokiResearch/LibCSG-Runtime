...
/**
* <summary>
* Class <c>SortArray</c> is a class to do a nth_element a partial sorting algorithm, used to create the mesh BVH.
* </summary>
**/
public class SortArray 
{
    ...
    public void nth_element(int first, int last, int nth, ref (int i,MeshMerge.FaceBVH f)[] array) {
